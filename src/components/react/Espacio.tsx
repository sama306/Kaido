    ...
    <>
      <section id="espacio" className="relative overflow-hidden pt-section px-6 bg-crema">
        <div
          ...
          style={{ backgroundImage: 'url(/images/pexels-coffee-beans-sunlight.jpg)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'bottom right', opacity: 0.1 }}
        />
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 justify-center mb-3">
            <span className="w-8 h-px bg-bordo/40" />
            <span className="text-small font-contenido font-medium uppercase tracking-[0.15em] text-dorado">GALERÍA</span>
            <span className="w-8 h-px bg-bordo/40" />
          </div>
            ...
            {imagenesEspacio.map((img) => (
              ...
              >
                <div
                  ...
                  style={{ backgroundImage: 'url(' + img.imagen + ')', backgroundSize: 'cover', backgroundPosition: 'center' }}
                />
        ...
        >
          ...
          >
            <div
              ...
              style={{ backgroundImage: 'url(' + selected.imagen + ')', backgroundSize: 'cover', backgroundPosition: 'center' }}
            />
          </div>
        </div>
      )}
